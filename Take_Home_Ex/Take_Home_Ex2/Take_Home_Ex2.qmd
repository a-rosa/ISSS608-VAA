...
This kind of incident needs to be prevented. But to do this, we need to first understand how many of those anomalous post done is human-initiated or agent-initiated. 
...
This shows that all the anomalous post are done by agents instead of the person themselves. 
