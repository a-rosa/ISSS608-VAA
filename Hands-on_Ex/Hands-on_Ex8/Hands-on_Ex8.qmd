---
title: "Hands-on Ex 8 - Visualising and Analysis Time-oriented Data"
...
-   `scale_fill_gradient()` function is used to creates a two color gradient (low-high).
:::
...
rice %>% 
  ...
  newggslopegraph(Year, Yield, Country,
                ...
                SubTitle = "1961-1980",
                Caption = "Prepared by: Amelia Rosalind")
```
