---
title: "Hands-on Exercise 9 Part 1 - Choropleth Mapping with R"
...
```{r}
p2 <- tm_shape(mpsz_pop2020)+ tm_polygons("DEPENDENCY", fill.scale = tm_scale_intervals(style = "quantile", n = 2))
p6 <- tm_shape(mpsz_pop2020)+ tm_polygons("DEPENDENCY", fill.scale = tm_scale_intervals(style = "quantile", n = 6))
p10 <- tm_shape(mpsz_pop2020)+ tm_polygons("DEPENDENCY", fill.scale = tm_scale_intervals(style = "quantile", n = 10))
p20 <- tm_shape(mpsz_pop2020)+ tm_polygons("DEPENDENCY", fill.scale = tm_scale_intervals(style = "quantile", n = 20))

tmap_arrange(p2, p6, p10, p20, ncol = 2)
```
